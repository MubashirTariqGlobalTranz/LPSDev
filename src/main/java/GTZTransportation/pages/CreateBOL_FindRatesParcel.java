...
public class CreateBOL_FindRatesParcel extends BaseClass {
	...
	@FindBy(xpath = "//a[@href='/Rates/Find.aspx?Mode=Parcel']//span[contains(text(),'Parcel')]")
	WebElement FindRatesParcel;
	...
	@FindBy(xpath = "//div[@data-bind='foreach: freightModes']//input[1]")
	WebElement LTLClick;
	
	//Initialization
	public CreateBOL_FindRatesParcel() {
